...
<body >
  ...
  <div class="flex-container" id="UserFlex" dir="rtl">

     <a href='FoodSuppliments.php'><div class="UserproductCard" >
       <div class="UserproductimgDiv">
         <img src="../images/food.png" alt="food supplements" class="Userproductimg">

       </div>
    <div class="Userproductdetails">
    ...
    <!-- <a href='MedicalDevices.php'><div class="UserproductCard" >
      <div class="UserproductimgDiv">

       <img src="../images/stethoscope.png" alt="" class="Userproductimg">
     </div>
   <div class="Userproductdetails">
   ...
   <!-- </div></a> -->
   <a href='BabySupplies.php'><div class="UserproductCard" >
     <div class="UserproductimgDiv">

      <img src="../images/baby.png" alt="" class="Userproductimg">
    </div>
  <div class="Userproductdetails">
    <h4>Baby Care</h4>
  ...
  <a href='WomenSupplies.php'><div class="UserproductCard" >
    <div class="UserproductimgDiv">

     <img src="../images/meditation.png" alt="" class="Userproductimg">
   </div>
  <div class="Userproductdetails">
   <h4>Woman Care</h4>
  ...
  <a href='SkinCare.php'><div class="UserproductCard" >
    <div class="UserproductimgDiv">

     <img src="../images/cosmetics.png" alt="" class="Userproductimg">
   </div>
  <div class="Userproductdetails">
   <h4>Skin Care</h4>
  ...
  <a href='HairCare.php'><div class="UserproductCard" >
    <div class="UserproductimgDiv">

     <img src="../images/comb.png" alt="" class="Userproductimg">
   </div>
  <div class="Userproductdetails">
   <h4>Hair Care</h4>
