...
<body >
  ...
  <div class="hairContainer">
    <div class="SCare sc" id="hairS">
      <p>Shampoo </p>
    </div>

    <div class="SCare sc foot" id="hairT">
      <p>Hair Coloring </p>
    </div>
    <div class="SCare sc sun" id="hairC">
      <p>Hair Treatments & oils</p>
    </div>
    <div class="SCare sc" id="hairB">
      <p>Hair Brushes</p>
    </div>
  </div>

  <div class="flex-container" id="hair_Container" dir="rtl" >
    <?php require_once 'hairScript.php'; ?>

    <?php
    $sql="SELECT * FROM shoppingCart WHERE Section='hairB' OR Section='hairC' OR Section='hairT' OR Section='hairS' ORDER BY RAND()LIMIT 8";
