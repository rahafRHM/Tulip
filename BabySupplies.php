...
<div class="BabyCare">
 ...
 <div class="SCare foot " id="BST">
    <p>Tools & Toys</p>
  </div>
  <div class="SCare diap_care" id="BSD">
    <p>body care & diapers</p>
  </div>
  <div class="SCare" id="BSF">
    <p>Food & Milk</p>
  </div>
</div>

<div class="flex-container" id="babyContainer" dir="rtl">
<?php require_once 'babyScript.php'; ?>
<?php
$sql="SELECT * FROM shoppingCart WHERE Section='BSF' OR Section='BSD' OR Section='BST' ORDER BY RAND()LIMIT 8";
